...
var _posts = require('./model/posts');
...
var anima = new _Animations2.default();
anima.start.resume();

},{"./components/Blog":3,"./components/Header":6,"./model/posts":8,"./utils/Animations":9}],3:[function(require,module,exports){
"use strict";
...
var Blog = function (_Component) {
    ...
    _createClass(Blog, [{
        ...
        value: function loadPosts() {
            ...
            _posts.blogPosts.map(function (post) {
                var newPost = new _Post2.default(post);
                _this2.posts.push(newPost);
                _this2.edits.push(new _Edit2.default(newPost));
            });
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return "\n\n            <div class=\"blog\">\n\n                " + this.posts.map(function (post, index) {
                return '<div class="post-item">' + post.render() + _this3.edits[index].render() + '</div>';
            }).join('') + "\n\n            </div>\n\n        ";
        }
    }]);
...
},{"../model/posts":8,"./Component":4,"./Edit":5,"./Post":7}],4:[function(require,module,exports){
"use strict";
...
},{"../app":2,"./Component":4}],7:[function(require,module,exports){
'use strict';
...
var Post = function (_Component) {
    ...
    function Post(props) {
        ...
        _this.edit = new _Edit2.default(_this);
        return _this;
    }
    ...
    _createClass(Post, [{
        ...
        key: 'showEdit',
        value: function showEdit(element) {
            var postItem = element.parentNode.parentNode.parentNode;
            var editElement = postItem.querySelector('.edit-modal');
...
},{"../app":2,"./Component":4,"./Edit":5}],8:[function(require,module,exports){
"use strict";
...
var blogPosts = [{
    ...
    "userId": 2,
    "id": 2,
    "author": "Erik Garfield",
    "thumb": "images/post-2.jpg",
    "title": "How can you change the world?",
    ...
    "id": 3,
    "author": "Miranda Lee",
    "thumb": "images/post-3.jpg",
    "title": "Here is our world",
...
var Animations = function Animations() {
    ...
    this.start = new _gsap.TimelineMax();

    var posts = document.querySelectorAll('.post-item');

    this.start.add(_gsap.TweenLite.from(posts[0], 1, { opacity: 0, top: 100, ease: Back.easeOut.config(1.7) }));
    this.start.add(_gsap.TweenLite.from(posts[1], .7, { opacity: 0, top: 100, ease: Back.easeOut.config(1.7) }));
    this.start.add(_gsap.TweenLite.from(posts[2], .7, { opacity: 0, top: 100, ease: Back.easeOut.config(1.7) }));

    this.start.add(_gsap.TweenLite.from(posts[0].querySelector('.btn-edit'), .5, {
        opacity: 0, scale: 1.5
    }));
    this.start.add(_gsap.TweenLite.from(posts[1].querySelector('.btn-edit'), .5, {
        opacity: 0, scale: 1.5
    }));
    this.start.add(_gsap.TweenLite.from(posts[2].querySelector('.btn-edit'), .5, {
        opacity: 0, scale: 1.5
    }));
};
